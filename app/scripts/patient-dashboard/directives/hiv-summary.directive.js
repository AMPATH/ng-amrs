...
(function() {
  ...
  function hivSummaryController(scope, $rootScope, EtlRestService, HivSummaryModel) {
    ...
    scope.showingMedicationChangeHistory = false;
    scope.viewMedicationChangeHistory = false;
    scope.openHistoricalSection = openHistoricalSection;
    scope.openMedicationHistorySection = openMedicationHistorySection;
    ...
    function openMedicationHistorySection() {
      $rootScope.$broadcast('viewMedicationChangeHistory', null);
      scope.showingMedicationChangeHistory = true;
    }
  }
