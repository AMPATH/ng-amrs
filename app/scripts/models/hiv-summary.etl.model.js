    ...
    function factory(UtilService) {
        ...
        function hivSummary(hivSummaryEtl) {
            ...
            var _encounterTypeName = !UtilService.isNullOrUndefined(hivSummaryEtl.encounter_type_name) ?
                hivSummaryEtl.encounter_type_name : '';
            ...
            var _prevEncounterTypeName = !UtilService.isNullOrUndefined(hivSummaryEtl.prev_encounter_type_name) ?
                hivSummaryEtl.prev_encounter_type_name : '';
