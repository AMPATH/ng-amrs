(function(){
  ...
  angular
    .module('mock.data')
      .factory('EtlMockService', EtlMockService);
      
  function EtlMockService() {
    var service = {
      getVitalsETLRestMock: getVitalsETLRestMock,
      getHivSummaryETLRestMock: getHivSummaryETLRestMock
    };
    return service;
    
    function getVitalsETLRestMock() {
      return {
          'person_id': 1000,
          'uuid': 'patient-uuid',
    ...
    function getHivSummaryETLRestMock() {
      return {
          'person_id': 1000,
          'uuid': 'patient-uuid',
