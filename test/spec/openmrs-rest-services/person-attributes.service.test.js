...
(function() {
    ...
    describe('OpenMRS Person Attributes Service unit tests', function(){
      ...
      it('should have person attributes service defined', function () {
       ...
       it('should make an api call to the person attributes resource when getPersonAttributeByUuid is called with a uuid', function () {
            var params={uuid:'patientUuid', personattributeuuid: 'attributeuuid' };                 
            httpBackend.expectGET(settingsService.getCurrentRestUrlBase()+'person/attribute?v='+v).respond(mockData.getMockPersonAttribute());
            personAttributesService.getPersonAttributeByUuid(params, function (data){   
       ...
       it('person attribute service should have the following  methods', function () {
      ...
      it('should get an attribute matching a specified key from a list of person attributes', function () {
