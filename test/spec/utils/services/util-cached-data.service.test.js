...
(function() {
    ...
    describe('util-cached data Service unit tests', function(){
      ...
      it('should be able to search from CachedLocations given the location name', function () {
        var locations;
        var searchText = 'loc'
      ...
      it('should be able to search from CachedLocations given the location description', function () {
        var locations;
        var searchText = 'Mock'
        cachedDataService.getCachedLocations(searchText,
          function(locations_){
      ...
      it('should get cached Location given the uuid', function () {
        var uuid = 'uuid_100';
        var location;
        cachedDataService.getCachedLocationByUuid(uuid, function(location_){
          location = location_;
        });
